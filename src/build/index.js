	  ...
	  module.exports = {
	    ...
	    data: {
	      items: [
	        ...
	        {name: 'showcase/itemlist', title: 'List'},
	        {name: 'showcase/calculator', title: 'Calculator'},
	        {name: 'showcase/new-fashion', title: 'Activity Page'}
	      ]
	    }
	  }

	module.exports.render = function() {with(this){return _h('example-list',{attrs:{"items":items,"dir":"src"}})}}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return _h('list',[(items)&&_l((items),function(item){return _h('cell',{attrs:{"append":"tree"}},[_h('example-list-item',{attrs:{"title":item.title,"url":item.url}})])})])}}
