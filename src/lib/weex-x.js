...
function resetStoreVM (store, state) {
  ...
  var logLevel = WXEnvironment.logLevel
  ...
  if (oldVm) {
    ...
    setTimeout(function () { return oldVm.$destroy(); })
  }
}
...
function enableStrictMode (store) {
  store._vm.$watch(function () { return this.state }, function () {
 ...
 * @return {function}
 */
function init (oriInit) {
  var hasInit = typeof oriInit === 'function'

  function xInit() {
    var ref = this;
    var _options = ref._options;
 ...
 * MIT License
 * https://github.com/vuejs/vuex/blob/next/src/helpers.js
 *
  ...
  normalizeMap(getters).forEach(function (ref) {
    ...
    res[key] = function mappedGetter () {
      if (!(val in this.$store.getters)) {
        console.error(("[weex-x] unknown getter: " + val))
      }
 ...
 * Vuex By Evan You (http://evanyou.me/)
 * MIT License
 * https://github.com/vuejs/vuex/tree/next
 *
 * Modified by Jinjiang
 */
...
//# sourceMappingURL=weex-x.js.map
